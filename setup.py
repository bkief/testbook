...
setup(
    ...
    url='https://github.com/bkief/testbook',  # Optional
    author='Brian Kiefer',  # Optional
    author_email='bkief22@outlook.com',  # Optional
    ...
    keywords='testing jupyter ipython',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/bkief/testbook/issues',
        'Source': 'https://github.com/bkief/testbook/',
    },
)
